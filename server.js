...
const app = express();
// Render automatically ek port deta hai, hum use use karenge
const PORT = process.env.PORT || 7860; 

app.get('/', (req, res) => {
    res.send("S-Cloud Stealth Engine is Running (Optimized)!");
});
...
app.get('/bypass', async (req, res) => {
    ...
    try {
        ...
        // Low-RAM aur Docker ke liye special Chrome flags
        browser = await puppeteer.launch({
            headless: true, // Naye Puppeteer me 'true' use hota hai
            ...
            args: [
                ...
                '--disable-gpu',
                '--no-zygote',
                '--single-process' // Yeh flag 512MB RAM me server crash hone se bachayega
            ]
        });
